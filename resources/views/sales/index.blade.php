...
<body class="bg-dark">    
    @include('navbar');
    <h1 class="text-light" style="text-align: center;">Sales</h1>
    <br><br>
    ...
    <div class="text-light">  
        <form method="GET" action="{{URL::route('sales.filter')}}">
            <div class="row pb-3">                                
                <div class="col md-1 pt-4"></div>   
                <div class="col md-2 pt-4">
                    <a class="btn btn-success" href="{{URL::route('sales.create')}}">Record Sale</a>
                </div>     
                <div class="col md-2">
                ...
                <div class="col-md-1 pt-4">
                    <a class="btn btn-danger" href="{{URL::route('sales.clearFilter')}}">Clear Filter</a>
                </div>                
                <div class="col-md-1 pt-4">
                    <a class="btn btn-warning text-light" href="{{URL::route('sales.pdf')}}">Download PDF (All)</a>
                </div>      
                @if (session('failure')) 
                    <div class="col-md-1 pt-4">
    ...
    <table id="example" class="table table-striped table-bordered bg-transparent text-light">
        ...
        <tbody>
            @foreach ($sales as $sale)
                    ...
                    <td>{{ $sale -> amount}}</td>
                    <td>                
                        <a class="btn btn-success" href="{{URL::route('sales.update', $sale->id)}}">
                            Update
                        </a>

                        <a class="btn btn-danger "href="{{URL::route('sales.delete', $sale->id)}}">
                            Delete
                        </a>
                    </td>
                    </tr>
