...
<head>
    ...
    <title>BOB | New Sales Record</title>
...
<body class="bg-dark">    
    @include('navbar');
    <h1 class="text-light" style="text-align: center;">Sales Record - Create</h1>
    <br><br>

    <form name="add-sale-post-form" id="add-sale-post-form" method="post" action="{{URL::route('sales.storeCreate')}}">
       @csrf
